...
import com.zhm.jobportal.jobPortal.repository.JobSeekerProfileRepository;
...
public class UsersService {
    ...
    public Users addNew(Users users){
        ...
        int typeId = users.getUserTypeId().getUserTypeId();
        if(typeId == 1){
    ...
    public Users findByEmail(String currentUsername) {
        return usersRepository.findByEmail(currentUsername).orElseThrow(()-> new UsernameNotFoundException("Could not found the user"));
    }
}
